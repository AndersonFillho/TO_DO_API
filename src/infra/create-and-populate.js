...
VALUES 
    (1, 'Anderson Ferreira', 'anderson.filho@hotmail.com', '****'),
    (2, 'Rafael Silva', 'rafael.silva@hotmail.com', '****'),
    (3, 'Gustavo Ribeiro', 'gustavo.ribeiro@hotmail.com', '****'),
    (4, 'Antony Ribeiro', 'antony.ribeiro@hotmail.com', '****'),
    (5, 'Felipe Oliveira', 'felipe.oliveira@hotmail.com', '****')
`
